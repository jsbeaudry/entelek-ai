              ...
              function e(e, n, i) {
                ...
                return (
                  ...
                  (B.items =
                    null !==
                      (k = Array.from(
                        B.el.querySelectorAll("[data-hs-combo-box-output-item]")
                      )) && void 0 !== k
                      ? k
                      : []),
                  (B.tabs = []),
              ...
              function e(e, n, i) {
                ...
                return (
                  ...
                  (k.pagingPrevList =
                    null !==
                      (u = Array.from(
                        k.el.querySelectorAll("[data-hs-datatable-paging-prev]")
                      )) && void 0 !== u
                      ? u
                      : null),
                  (k.pagingNextList =
                    null !==
                      (d = Array.from(
                        k.el.querySelectorAll("[data-hs-datatable-paging-next]")
                      )) && void 0 !== d
                      ? d
                      : null),
                  (k.infoList =
